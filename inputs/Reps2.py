...
class Reps():
    ...
    def __init__(self, words, outliers=None, cmudict_supplement=None, phonpath=None, oneletter=False, maxorth=None, maxphon=None, maxsyll=None, onehot=True, orthpad=9, phonpad=9, phon_index=0, justify='left', punctuation=False, numerals=False, tolower=True, test_reps=True):
        ...
        self.phonreps = phonemedict(phonpath)
        ...
        for length in set(self.phonlengths.values()):
            ...
            self.traindata[length]['wordlist'] = wordlist
            self.traindata[length]['orth'] = np.array(ortharray)
            self.traindata[length]['phon'] = np.array(phonarray)

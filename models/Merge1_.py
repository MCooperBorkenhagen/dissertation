...
t1 = time.time()
model.fit([Xo, Xp], Yp, batch_size=100, epochs=2, validation_split=(1-.9))
...
pronounce(5987, model, Xo_mask, Xp, Yp, labels=words, reps=phonreps)
#%%
model.fit([Xo, Xp_mask], Yp, batch_size=100, epochs=30, validation_split=(1-.9))

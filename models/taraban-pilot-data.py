...
tk = load('../inputs/taraban-pilot/taraban-pilot.traindata')
#words = pd.read_csv('../inputs/taraban-pilot/words.csv', header=None)
# phonreps and orthreps
phonreps = loadreps('../inputs/taraban-pilot/phonreps-with-terminals.json')
orthreps = loadreps('../inputs/raw/orthreps.json')
words = pd.read_csv('../inputs/taraban-pilot/words.csv', header=None)[0].tolist()
...
trainfile = open('data/taraban-pilot-train.csv', 'w')
trainfile.write('{},{},{}\n'.format('word','freq','freq_scaled'))

testfile = open('data/taraban-pilot-test.csv', 'w')
...
with open('data/taraban-pilot-K.txt', 'w') as f:
    f.write('{}\n'.format(K))
f.close()
...
# saves:
save(test, 'data/taraban-pilot-test.traindata')
save(train, 'data/taraban-pilot-train.traindata')

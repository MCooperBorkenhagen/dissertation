...
trainfile = open('data/taraban_pilot/taraban-train.csv', 'w')
trainfile.write('{},{},{}\n'.format('word','freq','freq_scaled'))

testfile = open('data/taraban_pilot/taraban-test.csv', 'w')
...
with open('data/taraban_pilot/taraban-K.txt', 'w') as f:
    f.write('{}\n'.format(K))
f.close()
...
# saves:
save(test, 'data/taraban_pilot/taraban-test.traindata')
save(train, 'data/taraban_pilot/taraban-train.traindata')

...
write.csv(nwf, 'data/monosyllabic-feedforward-wordwise-distances-late.csv', row.names=F)
...
write.csv(nwl, 'data/monosyllabic-lstm-wordwise-distances-late.csv', row.names=F)

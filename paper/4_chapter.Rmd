...
This virtue of the architecture represents a range of future directions that will be important for both basic inquiry into the nature of reading as well as the application of scientific models of learning like this one to educational issues. For example, this architecture can be used to understand to what extent phonic patterns (sublexical, segmental patterns of print and speech) emerge over the course of learning, and how they can be leveraged to support knowledge development. In this sense, given the advances in the computational system described here, this architecture could be used to more directly impact learning to read in the educational domain than previous, similar computational work from the connectionist learning literature and elsewhere. A discussion related to this point can be found in @Seidenberg2020.

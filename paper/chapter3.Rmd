...
tabledata %>% 
  ...
  apa_table(digits = 3, format = 'pandoc', note = 'Model estimated using lm() in R with confidence intervals estimated using confint(), both methods from the stats package. \n*p < .05 **p < .001')
```

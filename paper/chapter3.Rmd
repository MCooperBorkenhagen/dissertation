...
In order to validate the model using words with more than one syllable, two analyses are presented. First, a set of relevant predictors that mirror those examined in @Yap2009 are examined (those that are relevant to an orthography-to-phonology network). Then, experiments from @Chateau2003 are reported using stimuli from that study.

...
## Graded effects of consistency and frequency: replicating Plaut et al. (1996)
An additional simulation was conducted in order to replicate the effects from @Plaut1996 regarding the graded effects of consistency and the interaction with frequency. An additional simulation was required because of the special training set used in those simulations (specifically in terms of the @Taraban1987 word lists). The 

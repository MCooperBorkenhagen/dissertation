...
```{r plautFigureOriginal, echo=FALSE, out.width='200px', fig.align='center', fig.cap='Original results from Plaut et al. (1996) analogous to Figure 12 are provided, taken from the original study. The figure is reproduced by permission from Psychological Review.'}

...
A number of outlier words were removed from the set due to their idiosyncratic characteristics. Words removed if they were abbreviations, acronyms, or initialisms, which constituted XX% (XX total words) from the child language source data. Children's books contain language that is quite different from words commonly read in other genres.
